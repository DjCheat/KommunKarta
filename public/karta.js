// karta.js
    ...
    function adjustCheckboxListLayout() {
        ...
        // Skapa container för grid-layout
        const columnsContainer = document.createElement('div');
        columnsContainer.className = 'checkbox-columns-container';
        
        // Hämta alla labels och sortera dem
        const checkboxes = checkboxList.querySelectorAll('input[type="checkbox"]');
        
        // För varje kommun, skapa en ny label
        kommunKoder.forEach(kommunKod => {
            const kommunNamn = data[kommunKod];
            ...
            checkbox.id = kommunKod;
            checkbox.value = kommunKod;
            checkbox.checked = savedCheckboxState[kommunKod] || false;
            checkbox.addEventListener('change', toggleKommunColor);
